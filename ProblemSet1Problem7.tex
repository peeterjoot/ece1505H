...
\begin{equation}\label{eqn:ProblemSet1Problem7:20}
\begin{aligned}
...
\begin{equation}\label{eqn:ProblemSet1Problem7:40}
...
\begin{equation}\label{eqn:ProblemSet1Problem7:60}
f(\Bx) = A \Bx + \Bb,
\end{equation}

Given a point \( \Bz \in S \), and a \( \theta \in [0,1] \)

\begin{equation}\label{eqn:ProblemSet1Problem7:80}
\Bz = \theta \Bx + (1-\theta) \By,
\end{equation}

the image of that point is

\begin{equation}\label{eqn:ProblemSet1Problem7:100}
\begin{aligned}
f( \theta \Bx + (1-\theta)\By )
...
\begin{equation}\label{eqn:ProblemSet1Problem7:120}
\begin{aligned}
\theta f(\Bx) + (1-\theta) f(\By)
&= \theta ( A \Bx + \Bb ) + (1 -\theta) (A \By + \Bb) \\
&= \theta ( A \Bx + \Bb - A \By - \Bb ) + A \By + \Bb \\
