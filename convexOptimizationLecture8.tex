...
\imageFigure{../figures/ece1505-convex-optimization/l8convexProjectionFig3}{Epigraph of \( h \) is a filled bowl.}{fig:l8convexProjection:l8convexProjectionFig3}{0.3}
...
F8: each \( h_i \) is convex, so this is a sum of convex functions, and is therefore convex.
