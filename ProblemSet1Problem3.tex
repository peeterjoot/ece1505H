...
\begin{equation}\label{eqn:ProblemSet1Problem3:21}
\alpha a_{ij} + \beta b_{ij}
= \alpha a_{ji} + \beta b_{ji},
\end{equation}

or
\begin{equation}\label{eqn:ProblemSet1Problem3:41}
...
\begin{enumerate}
\item
\begin{equation}\label{eqn:ProblemSet1Problem3:61}
...
\begin{equation}\label{eqn:ProblemSet1Problem3:81}
\innerprod{A}{B} = \sum_{ij} a_{ij} b_{ij},
\end{equation}

Similarly, the inner product in the reverse order is

\begin{equation}\label{eqn:ProblemSet1Problem3:101}
\begin{aligned}
...
\end{equation}
\item
\begin{equation}\label{eqn:ProblemSet1Problem3:121}
\begin{aligned}
\innerprod{A + B}{C}
&= \Tr ((A + B)^\T C) \\
&= \Tr ((A^\T + B^\T) C) \\
&= \Tr (A^\T C + B^\T C) \\
&= \Tr (A^\T C) + \Tr (B^\T C) \\
&= \innerprod{A}{C} + \innerprod{B}{C} .\qedmarker
\end{aligned}
\end{equation}
\item
\begin{equation}\label{eqn:ProblemSet1Problem3:141}
\begin{aligned}
\innerprod{r A}{B}
&= \Tr (r A)^\T B \\
&= \Tr r A^\T B \\
...
\end{equation}
\item
\begin{equation}\label{eqn:ProblemSet1Problem3:161}
\innerprod{A}{A}
=
\sum_{ij} a_{ij}^2,
\end{equation}
