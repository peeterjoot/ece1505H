...
\begin{dmath}\label{eqn:convexOptimizationLecture7:400}
...
The max is observed to be convex, whereas the min is not nessessarily so.  
...
\imageFigure{../figures/ece1505-convex-optimization/l7MinFuncFig5}{CAPTION: l7MinFuncFig5}{fig:l7MinFunc:l7MinFuncFig5}{0.3}
