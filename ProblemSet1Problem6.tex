...
Make neat and clearly-labeled sketches of the ellipsoid \( \calE = \setlr{\Bx | (\Bx - \Bx_c)^\T P^{-1} (\Bx - \Bx_c) = 1} \) for the following sets of parameters:
...
\begin{equation}\label{eqn:ProblemSet1Problem6:20}
\begin{aligned}
\Be_1 &= \inv{\sqrt{2}}
\begin{bmatrix}
1 \\
...
\begin{equation}\label{eqn:ProblemSet1Problem6:40}
\begin{aligned}
\Be_1 &= \inv{\sqrt{2}}
\begin{bmatrix}
1 \\
...
\begin{equation}\label{eqn:ProblemSet1Problem6:60}
\begin{aligned}
\Be_1 &= \inv{\sqrt{5}}
\begin{bmatrix}
2 \\
...
\begin{equation}\label{eqn:ProblemSet1Problem6:140}
A = E J E^{-1},
\end{equation}

is determinant preserving, since

\begin{equation}\label{eqn:ProblemSet1Problem6:160}
\begin{aligned}
\Abs{ A }
&= \Abs{ E } \Abs{ J } \Abs{ E^{-1} } \\
...
\begin{equation}\label{eqn:ProblemSet1Problem6:120}
\begin{bmatrix}
3 & 1 \\
0 & 3
\end{bmatrix}, \quad
...
\begin{equation}\label{eqn:ProblemSet1Problem6:180}
\begin{bmatrix}
3 & 1 \\
-1 & 1
\end{bmatrix}
