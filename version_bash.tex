...
submods="figures/ece1505-convex-optimization mathematica ece1505-convex-optimization latex"
for i in $submods ; do
...
cd ece1505-convex-optimization

make scrpage2.sty # one time requirement, assuming you are using a newer latex distribution.
make
\end{lstlisting}
