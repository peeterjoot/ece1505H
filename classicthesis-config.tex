...
%
PLEASE FEEL FREE TO EMAIL ME FOR THE FULL VERSION IF YOU AREN'T TAKING ECE1505.%
}%
%
\input{censor1pg.tex}%
%
...
% ****************************************************************************************************
\newcommand{\myTitle}{Convex optimization\xspace}
\newcommand{\mySubtitle}{Notes and problems from UofT ECE1505H 2017\xspace}
\newcommand{\myDegree}{}
...
% To be posted to:
% https://peeterjoot.com/archives/math2017/ece1505.pdf
...
\hypersetup{%
    ...
    pdfsubject={Convex optimization},%
    pdfkeywords={Convex optimization} {ECE1505H} {University of Toronto},%
    pdfcreator={pdfLaTeX},%
