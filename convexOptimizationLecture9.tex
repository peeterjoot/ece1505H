...
\renewcommand{\basename}{convexOptimization9}
...
\beginArtNoToc
\generatetitle{ECE1505H Convex Optimization.  Lecture 9: XXX.  Taught by Prof.\ Stark Draper}
%\chapter{XXX}
\label{chap:convexOptimization9}
